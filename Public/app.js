document.addEventListener("DOMContentLoaded", () => {
    ...
    loadBooks(); // Call loadBooks once when the DOM is ready
    ...
    function viewChapters(bookId) {
        chapterContent.innerHTML = ''; // Clear any previously loaded chapter
    ...
    closeChapterButton.addEventListener('click', () => {
        ...
        chapterContent.innerHTML = ''; // Optionally clear the content when closed
    });
});